...
generate-proto:
	export PATH="$$PATH:$(GOPATH)/bin" && protoc -I ./api/evgeniyzavgorodny/protobuf -I ./api  --go_out=paths=source_relative:./pkg/graphqlpb ./api/evgeniyzavgorodny/protobuf/graphql.proto
