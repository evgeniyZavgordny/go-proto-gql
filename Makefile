...
generate-proto:
	export PATH="$$PATH:$(GOPATH)/bin" && protoc -I ./api/evgeniyZavgordny/protobuf -I ./api  --go_out=paths=source_relative:./pkg/graphqlpb ./api/evgeniyZavgordny/protobuf/graphql.proto
